...
Phen_sin::Phen_sin(string n,Etat*e, Serveur*s, double a, double b, long int c, long int d, double min, double max,  double u, double o):offs(a),ampl(b),phase(c),period(d),sat_min(min),sat_max(max),mu(u),sigma(o){
